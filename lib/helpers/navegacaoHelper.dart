...
import 'package:dojo_flutter_camera/view/exibirImagemView.dart';
import 'package:dojo_flutter_camera/view/principalView.dart';
import 'package:flutter/material.dart';

class NavegacaoHelper {
  static const rotaRoot = "/";
  static const rotaPrincipal = "/principal";
  static const rotaExibirImagem = "/exibirImagem";
  ...
  static RouteFactory rotas() {
    return (settings) {
      ...
      switch (settings.name) {
        ...
        case rotaExibirImagem:
          File imagemExtraidaParametro = parametros != null ? parametros["imagem"] : null;
          viewEncontrada = ExibirImagemView(imagemExtraidaParametro);
          break;
